...
public class Server {
    ...
    public void start() {
        ...
        try
        {
            ...
            while(state == WAITING) {
//                display("Tron.Server waiting for Clients on port " + port + ".");
        ...
        public void run() {
            ...
            if(clients.size() == totalClients) {
                ...
                for(int i = 0; i < clients.size(); ++i) {
                    ...
                    lightcycle.addStep(rand.nextInt((800 - 200) + 1) + 200,
                            rand.nextInt((800 - 200) + 1) + 200, true);
